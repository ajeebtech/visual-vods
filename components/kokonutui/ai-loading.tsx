...
export default function AILoadingState() {
    ...
    const currentText = LOADING_STATES[currentIndex];

    return (
        <div className="flex flex-col items-center justify-center min-h-[300px] w-full p-8 font-sans">
            <style jsx>{`
                #wifi-loader {
                    --background: #62abff;
                    --front-color: #000;
            ...
            <div id="wifi-loader">
                ...
                <div className="text" data-text={currentText} />
            </div>
        </div>
    );
}
