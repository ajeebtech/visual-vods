    ...
    return (
        <div className="flex items-center justify-center min-h-full w-full">
            <div className="space-y-4 w-full">
                <div className="ml-2 flex items-center space-x-2 text-gray-800 font-medium">
                    <LoadingAnimation
                ...
                <div className="relative">
                        ...
                        <div>
                            {visibleLines.map((line, index) => (
                                ...
                                >
                                    ...
                                    <div className="text-gray-700 flex-1 ml-1">
                                        {line.text}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div
                        className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none rounded-lg from-white/90 via-white/50 to-transparent"
                        style={{
                            background:
